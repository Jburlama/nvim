return {
	...
	config = function ()
		...
		vim.keymap.set("n", "d",":lua require('harpoon.ui').nav_file(2) <Cr>", {})
		vim.keymap.set("n", "e",":lua require('harpoon.ui').nav_file(3) <Cr>", {})
		vim.keymap.set("n", "m",":lua require('harpoon.ui').nav_file(4) <Cr>", {})
